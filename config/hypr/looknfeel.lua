...
-- R2-D2 companion theme: fixed dark base + wallpaper-driven accent
-- Regenerated by r2-d2-theme-apply from hypr-looknfeel.lua.in

local background = "rgba(18, 18, 18, 1.0)"
local shadow_color = "rgba(00000055)"
local shadow_inactive = "rgba(00000044)"
local active_border = "rgb(EAEAEA)"
local inactive_border = "rgb(606060)"

local group_border_active = { colors = { "rgba(eaeaea8c)", "rgba(eaeaea38)" }, angle = 90 }
local group_border_inactive = "rgba(3a3a3a55)"
local group_locked_active = { colors = { "rgba(eaeaeae0)", "rgba(eaeaea38)" }, angle = 90 }
