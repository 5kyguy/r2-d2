...
hl.bind("ALT + XF86MonBrightnessUp", hl.dsp.exec_cmd("r2-d2-brightness-display +1%"), { locked = true, repeating = true, description = "Brightness up precise" })
hl.bind("ALT + XF86MonBrightnessDown", hl.dsp.exec_cmd("r2-d2-brightness-display 1%-"), { locked = true, repeating = true, description = "Brightness down precise" })
...
hl.bind("SUPER + XF86AudioMute", hl.dsp.exec_cmd("r2-d2-cmd-audio-switch"), { locked = true, description = "Switch audio output" })
